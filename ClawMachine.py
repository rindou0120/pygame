...
icon = pygame.image.load("C:\pygame_clawer\img\icon.png")  # 請確認 icon.png 的路徑
...
claw_image = pygame.image.load("C:\pygame_clawer\img\claw.png")
claw_image = pygame.transform.scale(claw_image, (50, 50))  # Adjust size

toy_image = pygame.image.load("C:\pygame_clawer\img\duck.png")
